...
namespace TitasGailius\LarastanCastsMethod;
...
/**
 * Custom extension that extends Larastan's ModelPropertyExtension.
 *
 * This extension runs the `casts` method on the Model class when inspecting model properties,
 * which eliminates the need to explicitly define return array shapes for the `casts` method.
 * By extending Larastan's ModelPropertyExtension, we can automatically infer property types
 * from the model's cast definitions at runtime.
 */
